...
tickFont = {'size':12, 'color':"rgb(30,30,30)", 'family':"Montserrat"}
...
def loadData(fileName, columnName): 
    ...
    data[columnName]=[0 if int(i) < 0 else i for i in data]
...
app.layout = html.Div(
    ...
    children=[
    html.H1('History of the Coronavirus (COVID-19)'),
    ...
    html.Br(),
    html.Br(),
    html.H5('Source: Johns Hopkins University Center for Systems Science and Engineering (JHU CSSE)')
])
...
if __name__ == '__main__':
    app.run_server(port,debug=False)